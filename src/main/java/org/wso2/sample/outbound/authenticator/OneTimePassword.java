...
/**
 * This class is used to generate One Time Passwords and validate them.
 */
public class OneTimePassword {
    ...
    protected static String getRandomNumber(int size) {

        StringBuilder generatedToken = new StringBuilder();
        try {
            SecureRandom number = SecureRandom.getInstance(CustomAuthenticatorConstants.ALGORITHM_NAME);
    ...
    public static byte[] hmacShaGenerate(byte[] keyBytes, byte[] text) throws NoSuchAlgorithmException,
        ...
        Mac hmacSha;
        try {
            hmacSha = Mac.getInstance(CustomAuthenticatorConstants.ALGORITHM_HMAC);
        } catch (NoSuchAlgorithmException nsa) {
            hmacSha = Mac.getInstance(CustomAuthenticatorConstants.ALGORITHM_HMAC_SHA);
        }
